...
const DesktopFooter = () => {
    return (
        <>
            <footer className='hidden text-white bg-[var(--VeryDarkBlue)] h-full p-10 lg:flex justify-around'>

                <div className='flex h-full flex-col gap-20'>
                    <div className='h-30 w-36'>
                ...
                <div className='flex justify-center items-center'>
                    <ul className='flex justify-center items-left flex-col gap-2'>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Home</li>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Pricing</li>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Products</li>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>About Us</li>
                    </ul>
                </div>

                <div>
                    <ul className='flex justify-center items-left flex-col gap-2'>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Careers</li>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Community</li>
                        <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Privacy Policy</li>
                    </ul>
                </div>

                <div className='flex h-full flex-col gap-20 text-right'>
                    <form className='flex gap-6' action="">
                        <input className='p-3 text-sm w-52 text-black rounded-full outline-none' type="email" placeholder='Updates in your inbox…' />
                        <button className={`rounded-full text-[var(--VeryLightGray)] bg-[var(--BrightRed)] outline-none px-5 py-3 text-white shadow-2xl w-full hover:bg-[var(--clr-accent-300)]`}>
                            Go
                        </button >
                    </form>
...
const MobileFooter = () => {
    return (
        <>
            <footer className='lg:hidden text-white bg-[var(--VeryDarkBlue)] h-full flex flex-col items-center justify-center gap-12 py-10'>

                <form className='flex gap-4 w-full justify-center items-center' action="">
                    <input className='p-3 text-sm w-52 text-black rounded-full outline-none' type="email" placeholder='Updates in your inbox…' />
                    <button className={`rounded-full text-[var(--VeryLightGray)] bg-[var(--BrightRed)] outline-none px-5 py-3 text-white shadow-2xl w-full hover:bg-[var(--clr-accent-300)]`}>
                        Go
                    </button >
                ...
                <div className='flex justify-around items-start  w-full'>
                    <div className='flex justify-center items-center'>
                        <ul className='flex justify-center items-left flex-col gap-4'>
                            <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Home</li>
                            <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Pricing</li>
                            <li className='hover:text-[var(--BrightRed)] cursor-pointer'>Products</li>
                            <li className='hover:text-[var(--BrightRed)] cursor-pointer'>About Us</li>
                ...
                <div className='flex flex-row gap-8 w-full justify-center'>
                    ...
                    <img className='w-10' src={pinterest} alt="Pinterest" />
